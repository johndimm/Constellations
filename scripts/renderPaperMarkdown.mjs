  ...
  <head>
    ...
    <style>
      ...
      @media print {
        ...
        .content { border: none !important; background: #ffffff !important; }
        a { text-decoration: underline !important; }
        pre { background: #ffffff !important; }
        figure { break-inside: avoid; page-break-inside: avoid; }
        img { border: 1px solid rgba(0,0,0,0.15) !important; }
...
function main() {
  ...
  const paperMeta = `
    ...
    <p><b>John Dimm</b> · Lean Software Development · Draft for discussion (printable snapshot)</p>
    <p style="color: var(--muted); margin-top: -6px;">Source lives in <code>public/paper/*.md</code>. Generated by <code>npm run render:paper</code>.</p>
