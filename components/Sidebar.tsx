...
const Sidebar: React.FC<SidebarProps> = ({ selectedNode, onClose, externalToggleSignal }) => {
  ...
  const panelClasses = `fixed ${isMobile ? 'top-24' : 'top-16'} right-4 z-50 transition-transform duration-300 ease-in-out ${isMobile ? 'w-[calc(100vw-2rem)] max-w-[24rem]' : 'w-[24rem]'
